...
class PDF extends FPDF
{
    ...
    private $docType = 'invoice';//payment_record'; //options are 'invoice' , 'medical_record' , 'payment_record'
    private $direct_payment_total;
    protected $paymentRecordTitle = 'Record of Payments since January 1st';
    protected $notesOnly    = false;
    protected $notesPtId    = 238;

    protected $customDate   = false;//" 2019-12-01";
    ...
    {   
        ...
        */
        ...
        $this->direct_payment_total = $localTotals['direct_payments'];
    ...
    function addTable($localItems, $balances)
    {
        ...
        */
        ...
        if($this->docType == 'payment_record')
        {
        ...
        if( $this->displayPreviousBalance && $this->docType == 'invoice')
        {
        ...
        {
            $balance = $this->direct_payment_total;
            $lable = "Total: ";
        }
